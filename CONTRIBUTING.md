# Contributing
Thank you for your interest in contributing to netapp-openshift-console-trident! 🎉

We appreciate that you want to take the time to contribute! Please follow these steps before submitting your PR.

# Creating a Pull Request

1. Please search [existing issues](https://github.com/NetApp/netapp-openshift-console-trident/issues) to determine if an issue already exists for what you intend to contribute.
2. If the issue does not already exist, [create a new issue](https://github.com/NetApp/netapp-openshift-console-trident/issues/new) that explains the bug or feature request.
...
- In **Project Website**, enter: https://github.com/NetApp/netapp-openshift-console-trident
...
While we truly appreciate your efforts on pull requests, we **cannot** make any commitment for when, or if, your PR will be included in the netapp-openshift-console-trident project. Here are a few reasons why:
...
Thank you for considering to contribute to netapp-openshift-console-trident!
